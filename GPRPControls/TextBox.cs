...
namespace GPRP.GPRPControls
{
    ...
    public class TextBox : System.Web.UI.WebControls.TextBox, IWebControl
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            if (this.MaximumValue != null || this.MinimumValue != null)
            {
                ...
                if (this.MaximumValue != null && this.MinimumValue != null)
                {
                    ...
                    NumberRV.ErrorMessage = string.Format(ResourceManager.GetString("TextBox_ErrorMessage_Between"),this.MinimumValue,this.MaximumValue);// "当前输入数据应在" + this.MinimumValue + "和" + this.MaximumValue + "之间!";
                }
                else
                {
                    if (this.MaximumValue != null)
                    {
                        ...
                        NumberRV.ErrorMessage = string.Format(ResourceManager.GetString("TextBox_ErrorMessage_Max"),this.MaximumValue);// "当前输入数据允许最大值为" + this.MaximumValue;
                    }
                    if (this.MinimumValue != null)
                    {
                        NumberRV.MinimumValue = this.MinimumValue;
                        NumberRV.MaximumValue = Int32.MaxValue.ToString();
                        NumberRV.ErrorMessage = string.Format(ResourceManager.GetString("TextBox_ErrorMessage_Min"), this.MinimumValue); //"当前输入数据允许最小值为" + this.MinimumValue;
                    }
                }
                    ...
                    case "数据校验":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongNumber"); break;
                        }
                    case "电子邮箱":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongEmail"); break;
                        }
                    case "移动手机":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "\\d{11}";
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongCellPhone"); break;
                        }
                    case "家用电话":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongTelPhone"); break;
                        }
                    case "身份证号码":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^\\d{15}$|^\\d{18}$";
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongCard"); break;
                        }
                    case "网页地址":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongWebSite"); break;
                        }
                    case "日期":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : @"^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-8]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))$";
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongDate"); break;
                        }
                    case "日期时间":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : @"^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-8]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-)) (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d$";
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongDateTime"); break;
                        }
                    case "金额":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongMoney"); break;
                        }
                    case "IP地址":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongIP"); break;
                        }
                    case "IP地址带端口":
                        {
                            ...
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongIPPort"); break;
                        }
                    case "英文字母":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^[A-Za-z]+$";
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongEnglish"); break;
                       
                        }
                    case "大写字母":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^[A-Z]+$";
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongEnglishB"); break;

                        }
                    case "小写字母":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "^[a-z]+$";
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongEnglishS"); break;
                        }
                    case "数字检验":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "/[^d]/g";
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongOnlyNumber"); break;
                        }
                    case "英数检验":
                        {
                            RequiredFieldTypeREV.ValidationExpression = (this.ValidationExpression != null) ? this.ValidationExpression : "/[^W]/g";
                            RequiredFieldTypeREV.ErrorMessage = ResourceManager.GetString("TextBox_ErrorMessage_WrongOnlyEnglishNumber"); break;
                        }
                }
                ...
                case "必填":
                    {
                        ...
                        CanBeNullRFV.ErrorMessage = "<font color=red>" + ResourceManager.GetString("TextBox_ErrorMessage_NotNull") + "</font>";
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            if (this.TextMode == TextBoxMode.MultiLine)
            {
                ...
                base.Attributes.Add("onfocus", "this.className='FormFocusTextBoxMultiLine';");
                base.Attributes.Add("onblur", "this.className='FormBaseTextBoxMultiLine';");
                base.CssClass = "FormBaseTextBoxMultiLine";
            }
            else
            {
                if (this.Size > 0)
    ...
    public class RequiredFieldTypeControlsConverter : StringConverter
    {
        ...
        public override System.ComponentModel.TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            ...
            controlsArray.Add("英文字母");
            controlsArray.Add("大写字母");
            controlsArray.Add("小写字母");
