...
namespace GPRP.GPRPControls
{
    ...
    public class CheckBoxList : System.Web.UI.WebControls.CheckBoxList, IWebControl, IPostBackDataHandler
	{
        /// <summary>
        /// 构造函数        /// </summary>
		...
		public string GetSelectString(string split)
		{
			...
			return (result.LastIndexOf(split)==(result.Length-1))?result.Substring(0,result.Length-1):result;
		}
