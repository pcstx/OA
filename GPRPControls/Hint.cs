...
namespace GPRP.GPRPControls
{
    ...
    public class Hint : System.Web.UI.WebControls.WebControl
    {
        ...
        /// 宽度
        /// </summary>
        [Bindable(true), Category("Appearance"), DefaultValue("271")]
        public string WidthUp
        {
            get
            {
                if (base.ViewState["WidthUp"] != null)
                {
                    return (String)base.ViewState["WidthUp"];
                }
                else
                {
                    return "271";
        ...
        /// </summary>
        [Bindable(true), Category("Appearance"), DefaultValue("271")]
        public string WidthDown
        {
            get
            {
                if (base.ViewState["WidthDown"] != null)
                {
                    return (String)base.ViewState["WidthDown"];
                }
                else
                {
                    return "271";
            ...
            set
            {
                base.ViewState["WidthDown"] = value;
            }
        }
        #endregion
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            sb.Append("<div style=\"position:absolute; visibility: visible; width: " + WidthUp + "px;z-index:501;\">\r\n");
		    ...
		    sb.Append("</div>\r\n");
            sb.Append("<iframe id=\"hintiframeup\" style=\"position:absolute;z-index:100;width:" + WidthUp + "px;scrolling:no;\" frameborder=\"0\"></iframe>\r\n");
	        sb.Append("</span>\r\n");


            sb.Append("<span id=\"hintdivdown\" style=\"display:none; position:absolute;z-index:500;\">\r\n");
            sb.Append("<div style=\"position:absolute; visibility: visible; width: " + WidthDown + "px;z-index:501;\">\r\n");
            ...
            sb.Append("</div>\r\n");
            sb.Append("<iframe id=\"hintiframedown\" style=\"position:absolute;z-index:100;width:" + WidthDown + "px;scrolling:no;\" frameborder=\"0\"></iframe>\r\n");
            sb.Append("</span>\r\n");
