...
namespace GPRP.GPRPControls
{
    ...
    public class GridViewTempBrowse : ITemplate
    {
        ...
        private string m_BrowsePage;
        private string m_BrowseType;
        private int m_cellIndex;
        /// <summary>
        /// 此无参构造必须实现，否则出错
        /// </summary>
        public GridViewTempBrowse()
            : base()
        {
        }
        ...
        /// <param name="bReadOnly">TextBox是否只读</param>
        /// <param name="txtWidth">TextBox的宽度</param>
        public GridViewTempBrowse(string strTxtID, string strHeader, string strField, bool bReadOnly, int txtWidth, int FieldID, string FieldName, string FieldDBType, int FieldHTMLType, int FieldValidType, string ValidTimeTypeName, int HasRule, DataTable dtRule, DataTable dtColumnsIndex, string BrowsePage, string BrowseType, int cellIndex)
        {
            templateType = DataControlRowType.DataRow;
            m_strTxtID = strTxtID;
            m_strField = strField;
        ...
        public void InstantiateIn(System.Web.UI.Control container)
        {
            switch (templateType)
            {
                ...
                case DataControlRowType.DataRow:
                    ...
                    {
                        tb.Attributes.Add("onclick", "javascript:return btnBrowseDetailFieldClick(this,'" + m_BrowsePage + "','" + m_BrowseType + "','" + m_cellIndex.ToString() + "');");
                    }
                    ...
                    //imageButton.ID = "fieldImage" + m_strTxtID;
                    //imageButton.ImageAlign = ImageAlign.Middle;
                    //imageButton.ToolTip = "搜索";
                    //imageButton.ImageUrl = "../images/arrow_black.gif";
                    //imageButton.OnClientClick = "return btnBrowseDetailFieldClick(this,'" + m_BrowsePage + "','" + m_BrowseType + "');";
