...
{
    /// <summary>
    /// 站点基本设置描述类, 加[Serializable]标记为可序列化
    /// </summary>
    [Serializable]
    public class GeneralConfigInfo : IConfigInfo
    {
        ...
        private string m_Language = "en-US";//语言版

        private string m_ButtonEnable = "true";//就是一排按钮中是否可用与不可用
        private int m_PageSize = 20;//Gridview每页显示的记录数
        private string m_attachment_ImportExport = "temp";//导入导出文件专用文件夹
        private string m_attachment_RequestAttach = "temp";//流程中文件上传的目录

        private string m_CookieName = "GeobyEV";//系统中所运用的Cookies名称

        private string m_LoginVerifyType = "1"; //用户登入验证方式
        private string m_Ldap = "GeobyEV.com";  //LDAP地址
        private string m_LdapPath = "LDAP://geobyev.com/DC=geobyev,DC=com"; // LDAP路径
        private string m_SmtpServer = "172.166.0.13"; // SMTP服务器地址
        private string m_MailFrom = "WF@GeobyEV.com"; // 群发邮件地址
        private string m_AttachmentFileType = ".xls,.xlsx,.pdf"; //允许上传附件文件类型
        private int m_AttachmentFileSize = 20; //允许上传的附件的文件大小上限(M)
        #endregion
        ...
        {
            get { return "Copyright &copy; 2007-" + DateTime.Now.Year.ToString() + " <a href=\"http://www.geobyev.com\" target=\"_blank\">geobyev</a>."; }
        }
        ...
        public string ButtonEnable
        {
            ...
            set { m_ButtonEnable = value; }
        }

        /// <summary>
        /// GridView中每页显示的记录数 默认为20
        /// </summary>
        public int PageSize
        {
        ...
        /// 上传附件目录地址
        /// </summary>
        public string attachment_ImportExport
        {
            get { return m_attachment_ImportExport; }
            set { m_attachment_ImportExport = value; }
        }

        /// <summary>
        /// 上传附件目录地址
        /// </summary>
        public string attachment_RequestAttach
        {
            get { return m_attachment_RequestAttach; }
            set { m_attachment_RequestAttach = value; }
        }
        ...
        /// 用户登入验证方式
        /// </summary>
        public string LoginVerifyType
        {
            get { return m_LoginVerifyType; }
            set { m_LoginVerifyType = value; }
        }
        ...
        {
            get { return m_AttachmentFileType; }
            set { m_AttachmentFileType = value; }
        }
        ...
        {
            get { return m_AttachmentFileSize; }
            set { m_AttachmentFileSize = value; }
        }
        #endregion
    }
}
