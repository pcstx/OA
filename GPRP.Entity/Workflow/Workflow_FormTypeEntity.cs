...
namespace GPRP.Entity
{
    ...
    /// 实体
    /// </summary>
    public class Workflow_FormTypeEntity
    {

        private int m_FormTypeID;//编号
        private string m_FormTypeName;//名称
        private string m_FormTypeDesc;//描述
        ...
        {
            get { return m_FormTypeName; }
            set { m_FormTypeName = value; }
        }
        /// <summary>
        ///描述
        /// </summary>
        ...
        {
            get { return m_FormTypeDesc; }
            set { m_FormTypeDesc = value; }
        }
        /// <summary>
        ///显示顺序
        /// </summary>
