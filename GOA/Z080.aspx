<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Z080.aspx.cs" Inherits="GOA.Z080" %>
...
<body>
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div class="ManagerForm">
          <fieldset>
            <legend style="background: url(../../images/legendimg.jpg) no-repeat 6px 50%;">
              <asp:Label ID="lblBigTitle" runat="server" Text="用户组权限"></asp:Label></legend>
              <div class="clear">
                <div class="half">
                  <!--label-->
                  <div class="iptblk">
                    <asp:Label ID="lblGroupList" runat="server" Text="用户组列表"></asp:Label>&nbsp;<cc2:Button ID="btnSearch" runat="server" ButtonImgUrl="../../images/query.gif" Enabled="false" ShowPostDiv="false" Text="Button_Search" ValidateForm="false" AutoPostBack="false" /></div>
                  <br />
                  <asp:ListBox ID="GroupList" runat="server" Width="150" Height="400" OnSelectedIndexChanged="GroupList_OnSelectedIndexChanged" AutoPostBack="true"></asp:ListBox>
                </div>
                <div class="half">
              ...
              <div class="clear">
                <div class="half2">
                  <asp:Button ID="btnSave" runat="server" Text="提 交" CssClass="btnSave" OnClick="btnSave_Click" />&nbsp;&nbsp;<input id="Reset1" type="reset" value="重 置" class="btnSave" />&nbsp;&nbsp;<asp:Label ID="lblMsg" runat="server" Text=""></asp:Label></div>
                <div style="width: 10%;">
                  &nbsp;</div>
              </div>
          </fieldset>
    ...
    <Triggers>
      ...
      <asp:AsyncPostBackTrigger ControlID="GroupList" EventName="SelectedIndexChanged" />
    </Triggers>
  </asp:UpdatePanel>
  ...
  <asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopupQuery" Style="display: none; width: 650px; padding: 0 0px 0px 0px">
    ...
    <div>
      <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        <ContentTemplate>
          <div class="edit">
            <cc2:Button ID="btnQuery" ShowPostDiv="false" runat="server" Text="Label_NULL" AutoPostBack="true" ButtontypeMode="Normal" Page_ClientValidate="false" Disable="true" Width="16" CSS="SearchButtonCSS" OnClick="btnQuery_Click" />
          </div>
