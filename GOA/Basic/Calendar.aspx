...
<link rel="stylesheet" type="text/css" href="jquery-frontier-cal-1.3.2/css/frontierCalendar/jquery-frontier-cal-1.3.2.css" />



<link rel="stylesheet" type="text/css" href="jquery-frontier-cal-1.3.2/css/colorpicker/colorpicker.css" />

<link rel="stylesheet" type="text/css" href="jquery-frontier-cal-1.3.2/css/jquery-ui/smoothness/jquery-ui-1.8.1.custom.css" />


<script type="text/javascript" src="jquery-frontier-cal-1.3.2/js/jquery-core/jquery-1.4.2-ie-fix.min.js"></script>

<script type="text/javascript" src="jquery-frontier-cal-1.3.2/js/jquery-ui/smoothness/jquery-ui-1.8.1.custom.min.js"></script>


<script type="text/javascript" src="jquery-frontier-cal-1.3.2/js/colorpicker/colorpicker.js"></script>


<script type="text/javascript" src="jquery-frontier-cal-1.3.2/js/jquery-qtip-1.0.0-rc3140944/jquery.qtip-1.0.js"></script>


<script type="text/javascript" src="jquery-frontier-cal-1.3.2/js/lib/jshashtable-2.1.js"></script>

<script type="text/javascript" src="jquery-frontier-cal-1.3.2/js/frontierCalendar/jquery-frontier-cal-1.3.2.min.js"></script>
...
<div id="tabs">
	<div id="tabs-2">
		<div id="toolbar" class="ui-widget-header ui-corner-all" style="padding:3px; vertical-align: middle; white-space:nowrap; overflow: hidden;">
			<button id="BtnPreviousMonth">前一个月</button>
			<button id="BtnNextMonth">下一个月</button>
			&nbsp;&nbsp;&nbsp;
			Date: <input type="text" id="dateSelect" size="20"/>
			&nbsp;&nbsp;&nbsp;
			<button id="BtnDeleteAll">删除所有</button>
