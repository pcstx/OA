...
{
    public partial class _0101009 : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //修改表名,获取要显示的表结构,
                // add bear ViewState["sysTableColumn"] = DbHelper.GetInstance().GetSysTableColumnByTableName("PBDUT", "");
                //          ViewState["sysTable"] = DbHelper.GetInstance().GetSysTable("PBDUT");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "select")
            {
                ...
                //第一处待修改位置
                string keyCol = row.Cells[6].Text.ToString();
                //第二处待修改位置
                string strButtonHideScript = "<script type=\"text/javascript\"  lanuage=\"javascript\"> \r\n" +
                  "btnClick('" + row.Cells[7].Text.ToString() + "','" + keyCol + "'); \r\n" +
                 "</script> \r\n";
        ...
        {
          //add bear  DataTable dt = DbHelper.GetInstance().GetDBRecord("", "*", "PBDUT", "", "PBDUTOI", AspNetPager1.PageSize, AspNetPager1.CurrentPageIndex);    
            DataTable dt = DbHelper.GetInstance().GetDBRecord("", "*", "PBPOS", "", "PBPOSPC", AspNetPager1.PageSize, AspNetPager1.CurrentPageIndex);
            if (dt.Rows.Count > 0)
