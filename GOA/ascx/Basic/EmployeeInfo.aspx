		      ...
		      <legend style="background:url(../images/legendimg.jpg) no-repeat 6px 100%;"><asp:Label ID="lblBigTitle" runat="server" Text="用户信息"></asp:Label>
                 ...
                 <div class="clear">
                          <div class="conblk3" id="ProfileContainer" >
                                                          ...
                                                          <div class="iptblk">
                                                              ...
                                                              -->
                                                                ...
                                                                <div class="third2"><label class="char5"><!--直接主管-->  
                                                                 <asp:Label ID="lblPEEBIDL" runat="server" Text=""></asp:Label><span id="Span14" style="color:Red;">*</span></label><div class="iptblk"><cc2:TextBox ID="txtPEEBIDL" runat="server" Width="100" ></cc2:TextBox><input id="txtPersonCode" runat="server" type="hidden" /></div></div>
                                                                 </div>
	                       ...
	                       <fieldset> <legend style="background:url(../images/legendimg.jpg) no-repeat 6px 50%;"></legend>
	                     <div class="clear">
                                <div class="third2">
	                               <div id="MyAddItem"></div>
	                         ...
	                         <div class="clear">
	                          <div id="MyAddItem">
	                            ...
	                            <div id="addInfo">
                                       ...
                                       <asp:Button ID="btnSubmit" runat="server" Text="更新信息" OnClick="btnSubmit_Click" CssClass="btn"  />
                                       <asp:Button ID="btnAdd" runat="server" Text="添加用户"  OnClick="btnAdd_Click"  OnClientClick="return CheckInfo()" CssClass="btn"  />
                                 </div>
	                             </ContentTemplate>
                  </asp:UpdatePanel>
