<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="20101002.aspx.cs" Inherits="HRMWeb.aspx._0101002" %>
      ...
      <link href="../styles/dntmanager.css" type="text/css" rel="stylesheet" />
            ...
            <script type="text/javascript">
                function btnClick()
                {
                      ...
                      //window.opener.document.all.Tabs_Panel1_txtdepartmentCode.value='asdf';
                      //window.opener.document.all.Tabs_Panel1_txtPEEBIDEP.value='1247';
                      window.close();
                      return false;
                }
...
<body>
    ...
    <div>
     <asp:UpdatePanel ID="UpdatePanel6" runat="server">
         <ContentTemplate>   
                   <div class="edit">
                          <asp:Button ID="btnDepartmentSelect" runat="server" Text="确定" OnClientClick="return btnClick()" Width="26" CssClass ="OkButtonCSS"/>
		             </div> 
		             <div style="margin-left:80px;">
		             <asp:Panel ID="panelTree" runat="server"  ScrollBars="Auto"  >
		             
		                 <asp:TreeView ID="treeDeptartment" runat="server"  ShowCheckBoxes="All" OnTreeNodePopulate="treeDept_TreeNodePopulate"  ShowLines="true"></asp:TreeView>
