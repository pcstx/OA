...
namespace GOA.Basic
{
    public partial class RecieveMail : BasePage
    {
        ...
        private void BindGridView()
        {
            ...
            DataTable dt = DbHelper.GetInstance().GetDBRecords("RecvAdd=e.ReceiverID ,RecvName=l.UserName,MailTitle=e.MailTitle,Time=e.ReceiveTime,UserSerialID=e.UserSerialID", tables, WhereCondition, "e.ReceiveTime", AspNetPager1.PageSize, AspNetPager1.CurrentPageIndex);
            if (dt.Rows.Count > 0)
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "select")
            {
                ...
                int iResult = DbHelper.GetInstance().UpdateISReadByID(index,1);
                Response.Redirect("ShowMailList.aspx?action=recv&MailID=" + index);
