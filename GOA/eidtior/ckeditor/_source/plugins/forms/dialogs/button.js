...
CKEDITOR.dialog.add( 'button', function( editor )
{
	function commitAttributes( element )
	{
        ...
        element.attributes['HTMLTypeID'] = '1';
        element.attributes['DataTypeID'] = '0';
        element.attributes['FieldTypeID'] = '1';
        element.attributes['sqldbtype'] = 'VarChar';
        element.attributes['SqlDbLength'] = '200';
        element.attributes['TextLength'] = '0'; 
