(function() {
        ...
        title: /* title in string*/"浏览按钮",   //标题
            ...
            onOk: /*function*/
                function() {
                    ...
                    var fakeElement = editor.createFakeElement(element, 'cke_update', 'update',true);
            ...
            delete this.update;
                ...
                if (element && element.getAttribute('data-cke-real-element-type') == "update") {
                   this.update = element;
                   element = editor.restoreRealElement(this.update);
                    this.setupContent(element);
                   selection.selectElement(this.update);
                }
                ...
                elements: [
                        {
                            ...
                            commit: function(data) {
                                ...
                                element.data('cke-saved-HTMLTypeID', '8');
		                ...
		                },
					    {
					        ...
					        setup: function(element) {   //双击已增加控件回传值
					        this.setValue(element.data('cke-saved-browseType') ||
									element.getAttribute('browseType') ||
									'');
					        },
					        commit: function(data) {
					            var element = data.element;
					            ...
					            if (this.getValue()) {
					                element.data('cke-saved-browseType', this.getValue());
					                element.setText(this.getValue());
					            }
					            else {
					                element.data('cke-saved-browseType', false);
					                element.removeAttribute('browseType');
					            } 
					        }
					    },		                
                        {
    ...
    //增加对话框
    CKEDITOR.dialog.add('update', function(editor) {
