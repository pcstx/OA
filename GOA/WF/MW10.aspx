                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td style="height: 22px; vertical-align: middle">
                                                    ...
                                                    <a  href="#" onclick="parent.addTabs('MA10_new<%#DataBinder.Eval(Container,"DataItem.WorkFlowID") %>','<%#DataBinder.Eval(Container, "DataItem.WorkFlowName")%>','../WF/<%# "RequestAdd.aspx?IsAgent=0&WorkflowID=" + DataBinder.Eval(Container,"DataItem.WorkFlowID") %>')" >
