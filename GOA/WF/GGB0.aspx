<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GGB0.aspx.cs" Inherits="GOA.GGB0" %>
...
<head runat="server">
    ...
    {
      window.location="GGB0Detail.aspx?ReportID="+rid;
      return false ;
    }
     ...
     function btnFormClick()
      {
        ...
        var ret = window.showModalDialog(url,'GG30Select','scroll:1;status:0;help:0;resizable:1;dialogWidth:700px;dialogHeight:600px') ; 
                ...
                <div class="ManagerForm">
                    <fieldset>
                        ...
                        <div style="text-align: left">
                            <yyc:SmartGridView ID="GridView1" runat="server" AllowPaging="False" AllowSorting="True" AutoGenerateColumns="False" PageSize="10" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound" Width="600px" DataKeyNames="ReportID">
                                <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            报表ID</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnSelect1" runat="server" Font-Underline="true" Text='<%# Eval("ReportID") %>' CommandName="select" OnClientClick=<%# "return btnDetail_click('"+Eval("ReportID")+"');"%> />
                                        </ItemTemplate>
