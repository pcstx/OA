...
namespace GOA
{
    public partial class GG80Select : BasePage
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "select")
            {
                ...
                string ValidTypeID = GridView1.DataKeys[index].Value.ToString();
                //第二处待修改位置
                Workflow_BasicValidTypeEntity _Workflow_BasicValidTypeEntity = DbHelper.GetInstance().GetWorkflow_BasicValidTypeEntityByKeyCol(ValidTypeID);
                string strButtonSelectScript = "btnSelectClick('" + _Workflow_BasicValidTypeEntity.ValidTypeID + "','" + _Workflow_BasicValidTypeEntity.ValidTypeDesc + "');";
