<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MW50.aspx.cs" Inherits="GOA.MW50" %>
                        ...
                        <fieldset>
                            ...
                            <div style="text-align: left">
                                <yyc:SmartGridView ID="GridView1" runat="server" AllowPaging="False" AllowSorting="True" AutoGenerateColumns="False" EnableModelValidation="false" Width="100%" DataKeyNames="RequestID">
                                    <Columns>
                                        <asp:BoundField DataField="CreateDate" ItemStyle-Width="110px" HeaderText="创建日期" />
                                        <asp:BoundField DataField="Creator" ItemStyle-Width="100px" HeaderText="创建人" />
                                        <asp:BoundField DataField="WorkflowName" ItemStyle-Width="110px" HeaderText="工作流" />
