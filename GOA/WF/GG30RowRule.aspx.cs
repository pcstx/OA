...
namespace GOA
{
    public partial class GG30RowRule : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                ddlFieldIDTo.AddTableData(dtDetailField, 0, 1, true, "Select");
        ...
        {
            string WhereCondion = string.Format("a.FormID=b.FormID and a.GroupID=b.GroupID and a.FieldIDTo=b.FieldID and RuleType=1 and a.FormID={0} and a.GroupID={1}", DNTRequest.GetString("fid"), DNTRequest.GetString("gid"));
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            _FormDetailRuleEntity.RuleType = 1;
