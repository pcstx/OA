<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GG5002.aspx.cs" Inherits="GOA.GG5002" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      {
        if(document.all.txtNodeName.value.trim() == "")
        {
          alert("请输入节点名称。");
          document.all.txtNodeName.focus();
          return false;
        }
        if(document.all.txtNodeDesc.value.trim() == "")
        {
          alert("请输入节点描述。");
          document.all.txtNodeDesc.focus();
          return false;
        }
      ...
      function ShowNodeFieldDetail(id)
      {
        var url = "GG500201.aspx?GUID=" + Math.random() + "&id="+id;
        var ret = window.open(url, 'GG500201', 'height=750,width=1000,toolbar=no,menubar=no,scrollbars=no,resizable=yes,location=no,status=no');
        return !(ret === undefined)
      }
      
      function ShowOperatorDetail(id)
      {
        var url = "GG500202.aspx?GUID=" + Math.random() + "&id="+id;
        var ret = window.open(url, 'GG500202', 'height=680,width=860,toolbar=no,menubar=no,scrollbars=no,resizable=yes,location=no,status=no');
        return !(ret === undefined)
      }
      
      function ShowAddInOperationDetail(id, t)
      {
        var url = "GG500203.aspx?GUID=" + Math.random() + "&id="+id + "&t="+t;
        var ret = window.open(url, 'GG500203', 'height=680,width=1000,toolbar=no,menubar=no,scrollbars=no,resizable=yes,location=no,status=no');
        return !(ret === undefined)
      }
                                ...
                                <fieldset>
                                    ...
                                    <yyc:SmartGridView ID="GridView1" runat="server" AllowPaging="False" AutoGenerateColumns="False" PageSize="20" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound" Width="100%" DataKeyNames="NodeID">
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    节点表单字段</HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="btnNodeField" runat="server" ImageUrl="../images/icon_enter.gif" OnClientClick=<%#"ShowNodeFieldDetail('"+Eval("NodeID")+"')"%> />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    操作者</HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="btnOperator" runat="server" ImageUrl="../images/icon_enter.gif" OnClientClick=<%#"ShowOperatorDetail('"+Eval("NodeID")+"')"%> />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <CascadeCheckboxes>
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    ...
                    <div class="conblk2" xmlns:fo="http://www.w3.org/1999/XSL/Format">
                        <input type="hidden" id="txtNodeID" runat="server" />
                        <div class="con">
                            <div class="clear">
                                <div class="oneline">
                                    <label class="char5">
                                        节点名称：</label><div class="iptblk">
                                            <cc2:TextBox ID="txtNodeName" runat="server" Width="150"></cc2:TextBox><span style="color: Red;">*</span></div>
                                </div>
                            </div>
                            <div class="clear">
                                <div class="oneline">
                                    <label class="char5">
                                        节点描述：</label><div class="iptblk">
                                            <cc2:TextBox ID="txtNodeDesc" runat="server" Width="300"></cc2:TextBox><span style="color: Red;">*</span></div>
                                </div>
                            </div>
                            <div class="clear">
                                <div class="oneline">
                            ...
                            <div class="clear">
                                <div class="half">
                                    <label class="char5">
                                        是否超时提醒：</label><div class="iptblk">
                                            <asp:CheckBox ID="chkIsOverTime" runat="server" AutoPostBack="true" OnCheckedChanged="chkIsOverTime_CheckedChanged"></asp:CheckBox></div>
                                </div>
                                <div class="half">
                                    <label class="char5">
                                        超时时长(H)：</label><div class="iptblk">
                                            <cc2:TextBox ID="txtOverTimeLen" runat="server" Width="150"></cc2:TextBox></div>
                                </div>
                            </div>
                            <div class="clear">
                                <div class="oneline">
                                    <label class="char5">
                                        是否会签：</label><div class="iptblk">
                                            <asp:CheckBox ID="chkSignType" runat="server"></asp:CheckBox></div>
                                </div>
                            </div>
                            <div class="clear">
                                <label class="char5">
