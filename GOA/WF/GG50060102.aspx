<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GG50060102.aspx.cs" Inherits="GOA.GG50060102" %>
            ...
            <div class="ManagerForm">
                <fieldset>
                    <legend style="background: url(images/legendimg.jpg) no-repeat 6px 50%;">
                        <asp:Label ID="lblBigTitle" runat="server" Text="创建对象值匹配"></asp:Label></legend>
                    <div class="clear">
