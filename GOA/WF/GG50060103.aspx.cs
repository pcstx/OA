...
namespace GOA
{
    public partial class GG50060103 : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtCompareSymbol = DbHelper.GetInstance().GetDBRecords("a.SymbolCode,a.SymbolName", "Workflow_CompareSymbol a", "1=1", "a.DisplayOrder");
                ddlCompareSymbol.AddTableData(dtCompareSymbol, 0, 1, true, "Null");
                ...
                DataTable dtComputeRoute = DbHelper.GetInstance().GetDBRecords("ComputeType,RouteValue,RouteOrder", "Workflow_ComputeRouteColCondition", "RouteID=0", "RouteOrder");
        ...
        {
            DataTable dt = DbHelper.GetInstance().GetDBRecords("a.AddInOPID,a.TargetFieldName,a.TartgetValue,a.FieldTypeID,a.AndOr,c.SymbolCode,c.CompareSymbol,c.SymbolName,TartgetValueN='',b.FieldTypeName", "Workflow_NodeAddInOperation_Type1_ColCondition a,Workflow_FieldType b,Workflow_CompareSymbol c", "a.FieldTypeID=b.FieldTypeID and a.CompareSymbol=c.SymbolCode and a.AddInOPID=" + DNTRequest.GetString("opid"), "a.AddInOPID,a.AndOr,a.TargetFieldName");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "select")
            {
                ...
                DataTable dtComputeRoute = DbHelper.GetInstance().GetDBRecords("ComputeType,RouteValue,RouteOrder", "Workflow_ComputeRouteColCondition", string.Format("AddInOPID={0} and TargetField='{1}'", DNTRequest.GetString("opid"), TargetFieldName), "RouteOrder");
                ViewState["dtComputeRoute"] = dtComputeRoute;
        ...
        protected void btnDel_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                if (cb.Checked)
                {
                    ...
                    DbHelper.GetInstance().DeleteWorkflow_NodeAddInOperation_Type1_ColCondition(DNTRequest.GetString("opid"), TargetFieldName);
                }
            }
            BindGridView();
            System.Web.UI.ScriptManager.RegisterStartupScript(btnAdd, this.GetType(), "ButtonHideScript", strButtonHideScript, false);
        ...
        private string[] GetRuleDetail(DataRow dr)
        {
            ...
            DataTable dt = DbHelper.GetInstance().GetDBRecords("*", "Workflow_ComputeRouteColCondition", string.Format("AddInOPID={0} and TargetField='{1}'", AddInOPID, TargetField), "RouteID,RouteOrder");
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                if (Convert.ToInt32(dt.Rows[i]["ComputeType"]) == 1)
                {
                    DataTable dtDetail = DbHelper.GetInstance().GetDBRecords("b.ComputeSymbol", "Workflow_ComputeRouteColCondition a,Workflow_ComputeSymbol b", string.Format("a.RouteValue=b.ComputeID and a.RouteID={0}", dt.Rows[i]["RouteID"]), "");
