<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MW20.aspx.cs" Inherits="GOA.MW20" %>
                                ...
                                <table width="33%">
                                    <tr>
                                        <td style="height: 22px; font-size: 10pt; font-weight: bold">
                                            <a href="<%# "MW50.aspx?Type="+ Request.QueryString["Type"].ToString() +"&WorkflowID=&FormTypeID=" + DataBinder.Eval(Container,"DataItem.FlowTypeID") %>">
                                                <%# Eval("FormTypeName")%></a>
                                                ...
                                                <td style="height: 22px; vertical-align: middle">
                                                    <ul style="list-style-type: circle">
                                                        <li>
                                                            ...
                                                            <a href="<%# "MW50.aspx?Type="+ Request.QueryString["Type"].ToString() +"&FormTypeID=&WorkflowID=" + DataBinder.Eval(Container,"DataItem.WorkFlowID") %>">
