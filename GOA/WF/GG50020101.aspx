<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GG50020101.aspx.cs" Inherits="GOA.GG50020101" %>
                ...
                <div class="ManagerForm">
                    <fieldset>
                        <legend style="background: url(images/legendimg.jpg) no-repeat 6px 50%;">
                            <asp:Label ID="lblBigTitle" runat="server" Text="节点主字段控制"></asp:Label></legend>
                        <div class="clear">
                            <div class="oneline">
                                <fieldset>
                                    <!--page start-->
