<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GG500501.aspx.cs" Inherits="GOA.GG500501" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    删除</HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="btndel2" runat="server" ImageUrl="../images/del.gif" CommandName="del" ToolTip="删除" CommandArgument='<%# Container.DataItemIndex %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
