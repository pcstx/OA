<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AW30.aspx.cs" Inherits="GOA.AW30" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div style="float: left; width: 100%; overflow: auto">
                    <fieldset>
                        <legend>
                            <asp:Label ID="Labeltitle" runat="server">我的代理请求 * 查看</asp:Label></legend>
                        <table width="100%">
                            <tr>
                                            ...
                                            <table width="50%">
                                                <tr>
                                                    <td style="height: 22px; font-size: 10pt; font-weight: bold">
                                                        <a href="<%# "AW50.aspx?IsFinished=0&Type=4&WorkflowID=&FormTypeID=" + DataBinder.Eval(Container,"DataItem.FlowTypeID") %>">
                                                            <%# Eval("FormTypeName")%></a>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td style="height: 22px; vertical-align: middle">
                                                                ...
                                                                <a href="<%# "AW50.aspx?IsFinished=0&Type=4&FormTypeID=&WorkflowID=" + DataBinder.Eval(Container,"DataItem.WorkFlowID") %>">
                                    ...
                                    <asp:DataList ID="dlMain" runat="server" OnItemDataBound="dlMain_ItemDataBound" RepeatColumns="2" RepeatLayout="Flow" RepeatDirection="Vertical">
                                        <ItemTemplate>
                                            <table width="50%">
                                                <tr>
                                                    <td style="height: 22px; font-size: 10pt; font-weight: bold">
                                                        <a href="<%# "AW50.aspx?IsFinished=1&Type=4&WorkflowID=&FormTypeID=" + DataBinder.Eval(Container,"DataItem.FlowTypeID") %>">
                                                            <%# Eval("FormTypeName")%></a>
                                                ...
                                                <asp:Repeater ID="repeaterSub" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td style="height: 22px; vertical-align: middle">
                                                                <img src="../images/star.gif" alt="" />
                                                                <a href="<%# "AW50.aspx?IsFinished=1&Type=4&FormTypeID=&WorkflowID=" + DataBinder.Eval(Container,"DataItem.WorkFlowID") %>">
                                                                    <%#DataBinder.Eval(Container, "DataItem.WorkFlowName")%>
                                                                </a>
