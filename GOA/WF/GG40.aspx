...
<head id="Head1" runat="server">
    ...
    function ShowView(workflowID) {
        parent.addTabs("editWorkFlow", "可视化流程设计器", "../myWorkflow/index.html?workflowID=" + workflowID + "&t=" + (new Date()).valueOf());
    }
        ...
        <ContentTemplate>
            <div>
                ...
                <cc2:Button ID="btnDel" runat="server" ButtonImgUrl="../images/del.gif" Enabled="false" ShowPostDiv="false" Text="Button_Del" ValidateForm="false" AutoPostBack="true" Width="100" OnClick="btnDel_Click" />
                 <button class="ManagerButton" onclick='parent.addTabs("myWorkFlow", "可视化流程设计器", "../myWorkflow/index.html");'>可视化新增</button>
            </div>
            </div>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                  ...
                                                  <asp:LinkButton ID="btnSelectView" runat="server" Text="可视化编辑" OnClientClick=<%#"ShowView('"+Eval("WorkflowID")+"')"%> /> 
                                                </ItemTemplate>
                                            </asp:TemplateField>
