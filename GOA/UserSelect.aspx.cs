    ...
    public partial class UserSelect : BasePage
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "select")
            {
                ...
                string UserSerialID = GridView1.DataKeys[index][0].ToString().Trim();
                UserListEntity _UserListEntity = DbHelper.GetInstance().GetUserListEntityByKeyCol(UserSerialID);
                string UserName = _UserListEntity.UserName;
                string strButtonSelectScript = "btnSelectClick('" + UserSerialID + "','" + UserName + "');";
        ...
        protected void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            {
                string UserSerialID = selectedLines[i].ToString();
                sCode += UserSerialID + ",";
                UserListEntity _UserListEntity = DbHelper.GetInstance().GetUserListEntityByKeyCol(UserSerialID);
                string UserName = _UserListEntity.UserName;
                sName += UserName + ",";
