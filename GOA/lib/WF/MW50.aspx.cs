...
namespace GOA
{
    public partial class MW50 : BasePage
    {
        ...
        private void SetControlValue()
        {
            ...
            hiddenRequestID.Value = (Request.QueryString["RequestID"] != "" && Request.QueryString["RequestID"] != null) ? Request.QueryString["RequestID"] : "";
            hiddenIsFinish.Value = (Request.QueryString["IsFinished"] != "" && Request.QueryString["IsFinished"] != null) ? Request.QueryString["IsFinished"] : "";
            hiddenDeptID.Value = (Request.QueryString["DeptID"] != "" && Request.QueryString["DeptID"] != null) ? Request.QueryString["DeptID"] : "";
            hiddenTitle.Value = (Request.QueryString["Title"] != "" && Request.QueryString["Title"] != null) ? Server.UrlDecode(Request.QueryString["Title"]) : "";
            ...
            txtStartDate.Text = (Request.QueryString["StartDate"] != "" && Request.QueryString["StartDate"] != null) ? Request.QueryString["StartDate"] : "";
            txtEndDate.Text = (Request.QueryString["EndDate"] != "" && Request.QueryString["EndDate"] != null) ? Request.QueryString["EndDate"] : "";
        ...
        private void BindGridView()
        {
            ...
            dt = DbHelper.GetInstance().GetMyWorkflowSearchResult(GetArrayListParameter(), AspNetPager1.PageSize, AspNetPager1.CurrentPageIndex);
        ...
        protected void btnReturn_Click(object sender, EventArgs e)
        {
            if (hiddenType.Value == "1" || hiddenType.Value == "2" || hiddenType.Value == "3")
                Response.Redirect("MW20.aspx?type=" + hiddenType.Value);
            else if (hiddenType.Value == "4")
                Response.Redirect("MW30.aspx");
            else
                Response.Redirect("MW40.aspx");
        }
        ...
        private ArrayList GetArrayListParameter()
        {
            ...
            if (ddlFormType.SelectedValue == "0" && hiddenFormTypeID.Value == "")
                al.Add(System.DBNull.Value);
            else if (ddlFormType.SelectedValue != "0")
            ...
            if (txtWorkflowID.Value != "")
                al.Add(txtWorkflowID.Value.Trim());
            else
