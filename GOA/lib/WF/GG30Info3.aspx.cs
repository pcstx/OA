...
namespace GOA
{
    public partial class GG30Info3 : BasePage
    {
        ...
        private void RefreshDetailGroup()
        {
            ...
            for (int i = 0; i < dtDetailGroup.Rows.Count; i++)
            {
                ...
                FormFieldColRule _FormFieldColRule = (FormFieldColRule)(Page.LoadControl("UserControl/FormFieldColRule.ascx"));
                _FormFieldColRule.fid = FormID;
                _FormFieldColRule.gid = dtDetailGroup.Rows[i]["GroupID"].ToString();
                tp.Controls.Add(_FormFieldColRule);
