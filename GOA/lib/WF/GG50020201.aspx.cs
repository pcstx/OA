...
namespace GOA
{
    public partial class GG50020201 : BasePage
    {
        ...
        {
            DataTable dt = DbHelper.GetInstance().GetDBRecords("a.*,b.SymbolName,f.FieldLabel", "Workflow_OperatorCondition a,Workflow_CompareSymbol b,Workflow_NodeOperatorDetail c,Workflow_FlowNode d,Workflow_Base e,Workflow_FormField f", "a.SymbolCode=b.SymbolCode and a.RuleID=c.RuleID and c.NodeID=d.NodeID and d.WorkflowID=e.WorkflowID and e.FormID=f.FormID and a.FieldID=f.FieldID and a.RuleID=" + DNTRequest.GetString("id"), "a.BatchSeq,a.BranchBatchSeq");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "select")
            {
                ...
                DbHelper.GetInstance().DeleteWorkflow_OperatorCondition(ConditionID);
                UpdateSqlCondition();
            }
            BindGridView();
        }
        ...
        {
            DataTable dt = DbHelper.GetInstance().GetDBRecords("d.FieldID,d.FieldLabel", "Workflow_NodeOperatorDetail a,Workflow_FlowNode b,Workflow_Base c,Workflow_FormField d,Workflow_FieldDict e", "a.NodeID=b.NodeID and b.WorkflowID=c.WorkflowID and c.FormID=d.FormID and d.FieldID=e.FieldID and e.FieldTypeID=1 and a.RuleID=" + DNTRequest.GetString("id"), "d.DisplayOrder");
            DataRow dr = dt.NewRow();
            dr["FieldID"] = 0;
            dr["FieldLabel"] = "--请选择--";
        ...
        {
            DataTable dtSql = DbHelper.GetInstance().GetDBRecords("a.BatchSeq,a.BranchBatchSeq,a.FieldID,g.FieldName,g.HTMLTypeID,g.DataTypeID,g.Dateformat,b.SymbolCode,b.CompareSymbol,a.CompareToValue,a.AndOr", "Workflow_OperatorCondition a,Workflow_CompareSymbol b,Workflow_NodeOperatorDetail c,Workflow_FlowNode d,Workflow_Base e,Workflow_FormField f,Workflow_FieldDict g", "a.SymbolCode=b.SymbolCode and a.RuleID=c.RuleID and c.NodeID=d.NodeID and d.WorkflowID=e.WorkflowID and e.FormID=f.FormID and a.FieldID=f.FieldID and f.FieldID=g.FieldID and a.RuleID=" + DNTRequest.GetString("id"), "a.BatchSeq,a.BranchBatchSeq");
            ...
            DbHelper.GetInstance().ExecSqlText(string.Format("update Workflow_NodeOperatorDetail set RuleCondition='({0})' where RuleID={1}", sql, DNTRequest.GetString("id")));
