...
namespace GOA
{
    public partial class AW10 : BasePage
    {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (dlSub != null)
                {
                    string sql = @"SELECT cl.WorkflowID  ,b.WorkflowName
                                    ...
                                    left join  Workflow_Base b on  cl.WorkflowID=b.WorkflowID
                                    left join Workflow_FormType ft on  b.FlowTypeID=ft.FormTypeID
                                    where cl.IsCancel='0' and cl.AgentPersonID=" + userEntity.UserSerialID + " and b.FlowTypeID=" + Convert.ToInt32(FlowTypeID);
