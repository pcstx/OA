<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GG50060103.aspx.cs" Inherits="GOA.GG50060103" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      {
        if(document.all.ddlTargetFieldName.value == "")
        {
          alert("请选择目标字段。");
          document.all.ddlTargetFieldName.focus();
          return false;
        }
        if(document.all.ddlCompareSymbol.value == "")
        {
          alert("请选择比较方式。");
          document.all.ddlCompareSymbol.focus();
          return false;
        }
            ...
            <div class="ManagerForm">
                <fieldset>
                    <legend style="background: url(images/legendimg.jpg) no-repeat 6px 50%;">
                        <asp:Label ID="lblBigTitle" runat="server" Text="创建对象值筛选"></asp:Label></legend>
                    <div class="clear">
                                    ...
                                    <div class="half">
                                        <label class="char5">
                                            目标字段：</label><div class="iptblk">
                                                <cc2:DropDownList ID="ddlTargetFieldName" runat="server" Width="150">
                                                </cc2:DropDownList>
                                                <span style="color: Red;">*</span></div>
                                    </div>
                                    <div class="half">
                                        <label class="char5">
                                            比较方式：</label><div class="iptblk">
                                                <cc2:DropDownList ID="ddlCompareSymbol" runat="server" Width="150">
                                                </cc2:DropDownList>
                                                <span style="color: Red;">*</span></div>
                                    </div>
                                </div>
                                ...
                                <div class="clear">
                                    <div class="half">
                                        <asp:RadioButtonList ID="rblFieldType" runat="server" OnSelectedIndexChanged="rblFieldType_SelectedIndexChanged" AutoPostBack="true" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="1" Text="主字段"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="明细字段"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
                                    <div class="half">
                                        <label class="char5">
                                            主/明细字段：</label><div class="iptblk">
                    ...
                    <yyc:SmartGridView ID="GridView1" runat="server" AllowPaging="False" AutoGenerateColumns="False" PageSize="20" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound" Width="100%" DataKeyNames="TargetFieldName">
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    序号
                            ...
                            <asp:BoundField DataField="TartgetValue" HeaderText="赋值表达式" Visible="false" />
                            <asp:BoundField DataField="TartgetValueN" HeaderText="赋值表达式" />
                            <asp:BoundField DataField="FieldTypeName" HeaderText="主/明细字段" />
