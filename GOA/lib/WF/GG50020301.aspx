<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GG50020301.aspx.cs" Inherits="GOA.GG50020301" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      {
        if(document.all.ddlParameterList.value == "0")
        {
          alert("请选择目标参数。");
            ...
            <div class="ManagerForm">
                <fieldset>
                    ...
                    <legend style="background: url(images/legendimg.jpg) no-repeat 6px 50%;">
                        <asp:Label ID="lblBigTitle" runat="server" Text="数据集参数一览"></asp:Label></legend>
                    <yyc:SmartGridView ID="GridView1" runat="server" AllowPaging="False" AutoGenerateColumns="False" PageSize="20" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound" Width="100%" DataKeyNames="DSParameter">
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    序号
                            ...
                            <asp:BoundField DataField="DSParameter" HeaderText="参数名" />
                            <asp:BoundField DataField="ParameterType" HeaderText="参数类型" />
                            <asp:BoundField DataField="ParameterDirection" HeaderText="传参方式" />
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    参数值</HeaderTemplate>
                                <ItemTemplate>
