...
namespace GOA
{
    public partial class GG30Select : BasePage
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "select")
            {
                ...
                string FormName = _Workflow_FormBaseEntity.FormName;
                string strButtonSelectScript = "btnSelectClick('" + FormID + "','" + FormName + "');";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string KeyCol = ((DataRowView)e.Row.DataItem).Row["FormID"].ToString();
