<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nodeCondition.aspx.cs" Inherits="GOA.nodeCondition" %>
...
//        }
      ...
      function getSelectValue() {
          var r = { sqlCondition: "1", condition: "2" };
            r.sqlCondition = document.getElementById("HiddenSqlCondition").value;
            r.condition = document.getElementById("HiddenCondition").value;
          return r;
        //  window.alert(value);
      }
                            ...
                            <div class="oneline">
                                ...
                                <fieldset>
                                    <div id="pager">
                                        ...
                                        <cc2:Button ID="btnSubmit" runat="server" ButtonImgUrl="../images/submit.gif" ShowPostDiv="false" ValidateForm="false" Text="Button_DafaultSubmit"  AutoPostBack="true" Width="80" OnClick="Button2_Click" />
                              
                                 <input id="HiddenCondition" type="hidden" runat="server"/>
                                <input id="HiddenSqlCondition" type="hidden" runat="server"/>   
                                    </div>
                                    <!--gridview start-->
