...
(function ($)
{
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        addTabItem: function (options)
        {
            ...
            var tabitem = $("<span class='l-tab-links-item-break'></span><li><a></a><div class='l-tab-links-item-left'></div><div class='l-tab-links-item-right'></div><div class='l-tab-links-item-close'></div></li>");
        ...
        removeTabItem: function (tabid)
        {
            ...
            $(".l-tab-links-item-break[tabid=" + tabid + "]").remove();  //删除分割线
