<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Z070.aspx.cs" Inherits="GOA.Z070" %>
...
<head id="Head1" runat="server">
  ...
  <script language="javascript" type="text/javascript">
      ...
      {
        if(document.all.txtGroupName.value.trim() == "")
        {
          alert("请输入用户组名称。");
          document.all.txtGroupName.focus();
          return false;
        }
        if(document.all.txtGroupDesc.value.trim() == "")
        {
          alert("请输入用户组描述。");
          document.all.txtGroupDesc.focus();
          return false;
        }
...
<body>
        ...
        <div class="ManagerForm">
          <fieldset>
            <legend style="background: url(../../images/legendimg.jpg) no-repeat 6px 50%;">
              <asp:Label ID="lblBigTitle" runat="server" Text="用户组一览"></asp:Label></legend>
            <div class="clear">
              <div class="oneline">
                <fieldset>
                  <!--page start-->
  ...
  <asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopupControlForAdd" Style="display: none; width: 650px; padding: 0 0px 0px 0px">
    <div id="programmaticAddPopupDragHandle" class="programmaticPopupDragHandle">
      <div class="h2blk">
        <h2 id="H2_1">
          <asp:Label ID="Label1" runat="server" Text="用户组设置"></asp:Label></h2>
      </div>
          ...
          <div class="conblk2" xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <div class="con">
              <div class="clear">
                <div class="oneline">
                  <label class="char5">
                    用户组名称：</label><div class="iptblk">
                      <cc2:TextBox ID="txtGroupName" runat="server" Width="150"></cc2:TextBox><span style="color: Red;">*</span></div>
                </div>
              </div>
              <div class="clear">
                <div class="oneline">
                  <label class="char5">
                    用户组描述：</label><div class="iptblk">
                      <cc2:TextBox ID="txtGroupDesc" runat="server" Width="300"></cc2:TextBox><span style="color: Red;">*</span></div>
                </div>
              </div>
              <div class="clear" align="center">
                <div class="oneline">
                  <label class="char5">
                    该用户组用户：</label><div class="iptblk">
              ...
              <div class="clear">
                <div class="oneline">
                  ...
                  <yyc:SmartGridView ID="GridView2" runat="server" AllowPaging="true" PageSize="10" AutoGenerateColumns="False"  OnRowCommand="GridView2_RowCommand" Width="100%" DataKeyNames="UserSerialID">
                    <Columns>
                      <asp:TemplateField>
                        <HeaderTemplate>
                          序号
                      ...
                      <div class="half">
                        <label class="char5">
                          名称：</label><div class="iptblk">
                            <cc2:TextBox ID="txtQGroupName" runat="server" Width="90"></cc2:TextBox></div>
                      </div>
                      <div class="half">
                        <label class="char5">
                          描述：</label><div class="iptblk">
                            <cc2:TextBox ID="txtQGroupDesc" runat="server" Width="90"></cc2:TextBox></div>
                      </div>
                    </div>
                  </div>
                </div>
