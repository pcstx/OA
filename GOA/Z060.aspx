<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Z060.aspx.cs" Inherits="GOA.Z060" %>
...
<head id="Head1" runat="server">
  ...
  <script language="javascript" type="text/javascript">
      ...
      {
        if(document.all.txtRoleName.value.trim() == "")
        {
          alert("请输入角色名称。");
          document.all.txtRoleName.focus();
          return false;
        }
        if(document.all.txtRoleDesc.value.trim() == "")
        {
          alert("请输入角色描述。");
          document.all.txtRoleDesc.focus();
          return false;
        }
...
<body>
        ...
        <div class="ManagerForm">
          <fieldset>
            <legend style="background: url(../../images/legendimg.jpg) no-repeat 6px 50%;">
              <asp:Label ID="lblBigTitle" runat="server" Text="角色一览"></asp:Label></legend>
            <div class="clear">
              <div class="oneline">
                <fieldset>
                  <!--page start-->
  ...
  <asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopupControlForAdd" Style="display: none; width: 650px; padding: 0 0px 0px 0px">
    <div id="programmaticAddPopupDragHandle" class="programmaticPopupDragHandle">
      <div class="h2blk">
        <h2 id="H2_1">
          <asp:Label ID="Label1" runat="server" Text="角色设置"></asp:Label></h2>
      </div>
      ...
      <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        <ContentTemplate>
          ...
          <div class="conblk2" xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <input type="hidden" id="txtRoleID" runat="server" />
            <input type="hidden" id="txtUserSerialID" runat="server" />
            <div class="con">
              <div class="clear">
                <div class="oneline">
                  <label class="char5">
                    角色名称：</label><div class="iptblk">
                      <cc2:TextBox ID="txtRoleName" runat="server" Width="150"></cc2:TextBox><span style="color: Red;">*</span></div>
                </div>
              </div>
              <div class="clear">
                <div class="oneline">
                  <label class="char5">
                    角色描述：</label><div class="iptblk">
                      <cc2:TextBox ID="txtRoleDesc" runat="server" Width="300"></cc2:TextBox><span style="color: Red;">*</span></div>
                </div>
              </div>
              <div class="clear" align="center">
                <div class="oneline">
                  <label class="char5">
                    该角色用户：</label><div class="iptblk">
                      <cc2:TextBox ID="txtUserName" runat="server" Width="300"></cc2:TextBox>
                      <asp:ImageButton ImageUrl="../../images/arrow_black.gif" ImageAlign="Middle" ID="ImageButton2" ToolTip="搜索" runat="server" OnClientClick="return btnUserListClick();" />
                      <cc2:Button ID="btnAddRow" runat="server" Enabled="false" ShowPostDiv="false" Text="Button_MoveIn" ValidateForm="false" AutoPostBack="true" Width="80" OnClick="btn_AddRow" /></div>
                </div>
              </div>
              <div class="clear">
                <div class="oneline">
                  <yyc:SmartGridView ID="GridView2" runat="server" AllowPaging="False" AutoGenerateColumns="False" PageSize="20" OnRowCommand="GridView2_RowCommand" Width="100%" DataKeyNames="UserSerialID">
                    <Columns>
                      <asp:TemplateField>
                        <HeaderTemplate>
                          序号
                      ...
                      <div class="half">
                        <label class="char5">
                          名称：</label><div class="iptblk">
                            <cc2:TextBox ID="txtQRoleName" runat="server" Width="90"></cc2:TextBox></div>
                      </div>
                      <div class="half">
                        <label class="char5">
                          描述：</label><div class="iptblk">
                            <cc2:TextBox ID="txtQRoleDesc" runat="server" Width="90"></cc2:TextBox></div>
                      </div>
                    </div>
                  </div>
                </div>
